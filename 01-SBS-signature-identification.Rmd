...
If you have no idea to select a optimal signature number from technologies above, you can try auto-extract feature here.

```{r}
mt_sig <- sig_auto_extract(mt_tally$nmf_matrix, K0 = 10, nrun = 5)
```